const MESSAGE = {
    ...
    // On the creation of a user the username already exist
    'USERNAME_EXIST': 'Nombre de usuario ya existente',

    // On the creation of a user the email already exist
    'EMAIL_EXIST': 'Email ya esta en uso',
